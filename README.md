<html>
  ...
  <head>
    <title>Will You Be My Gurl! 😍</title>
  </head>
  ...
  <style>
    ...
    body::before{content:"\00A9  aoudumber.dev - Instagram";color:white;opacity:.3;font-size:2vw;position:fixed;bottom:25px;left:25px;z-index:2}
